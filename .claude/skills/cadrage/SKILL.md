...
Ne pas demander : la stack (elle est figée, voir CLAUDE.md), le modèle de données, les écrans, les user stories.
...
Écrire `SPEC.md` et `BACKLOG.md` en suivant leurs templates. Puis s'arrêter — ne pas enchaîner sur du code. Dire à l'utilisateur qu'il peut lancer `/slice` quand il veut démarrer.
